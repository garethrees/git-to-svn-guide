...
#### 15.1.1.1 Clone Trunk:

```bash
$ svn checkout https://code.example.com/repo/trunk repo 
```

#### 15.1.1.2 Create Feature Branch:
...
#### 15.1.1.6 Commit New Files:

```bash
$ svn commit -m “Made some awesome” 
```

#### 15.1.1.7 Switch to Trunk:

```bash
$ svn switch https://code.example.com/repo/trunk 
```

#### 15.1.1.8 Update From Upstream:

```bash
$ svn update 
```

#### 15.1.1.9 Merge New Feature:

```bash
$ svn merge --reintegrate https://code.example.com/repo/features/feature_branch 
```

#### 15.1.1.10 Commit Merge:
